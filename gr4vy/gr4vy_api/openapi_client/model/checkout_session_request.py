...
class CheckoutSessionRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        """CheckoutSessionRequest - a model defined in OpenAPI

        Args:
            id (str): The ID of the Checkout Session.

        Keyword Args:
            method (str): `checkout-session`.. defaults to "checkout-session", must be one of ["checkout-session", ]  # noqa: E501
        ...
        method = kwargs.get('method', "checkout-session")
