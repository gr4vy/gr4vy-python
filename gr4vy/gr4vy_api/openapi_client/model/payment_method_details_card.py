...
class PaymentMethodDetailsCard(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PaymentMethodDetailsCard - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            card_type (str): The type of card, one of `credit`, `debit` or `prepaid`.. [optional]  # noqa: E501
            bin (str): The first 6 digits of the full card number (the BIN).. [optional]  # noqa: E501
        """
