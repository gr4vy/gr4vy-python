...
class FlowRuleBooleanOutcome(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FlowRuleBooleanOutcome - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): The type of action outcome for the given rule.. defaults to "boolean", must be one of ["boolean", ]  # noqa: E501
            result (bool): Results for a given flow action.. defaults to True, must be one of [True, ]  # noqa: E501
