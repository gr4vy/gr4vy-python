...
class ThreeDSecureError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, detail, code, component, *args, **kwargs):  # noqa: E501
        """ThreeDSecureError - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, detail, code, component, *args, **kwargs):  # noqa: E501
        """ThreeDSecureError - a model defined in OpenAPI
