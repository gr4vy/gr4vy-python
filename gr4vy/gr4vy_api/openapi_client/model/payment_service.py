...
def lazy_import():
    from gr4vy.gr4vy_api.openapi_client.model.payment_service_fields import PaymentServiceFields
    globals()['PaymentServiceFields'] = PaymentServiceFields
...
class PaymentService(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'open_loop': (bool,),  # noqa: E501
            'payment_method_tokenization_enabled': (bool,),  # noqa: E501
            'network_tokens_enabled': (bool,),  # noqa: E501
            ...
            'merchant_profile': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
            ...
            'fields': ([PaymentServiceFields],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            open_loop (bool): Defines if the service works as an open-loop service. This feature can only be enabled if the PSP is set up to accept previous scheme transaction IDs.. [optional]  # noqa: E501
            ...
            network_tokens_enabled (bool): Defines if network tokens are enabled for the service. This feature can only be enabled if the payment service is set as `open_loop` and the PSP is set up to accept network tokens.. [optional]  # noqa: E501
            ...
            merchant_profile ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): An object containing a key for each supported card scheme, and for each key an object with the merchant profile for this service and the corresponding scheme.. [optional]  # noqa: E501
