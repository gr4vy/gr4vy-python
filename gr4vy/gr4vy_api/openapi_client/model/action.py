...
class Action(ModelNormal):
    ...
    allowed_values = {
        ...
        ('flow',): {
            ...
            'REDIRECT-TRANSACTION': "redirect-transaction",
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The identifier for the action.. [optional]  # noqa: E501
            flow (str): The name of the Flow.. [optional]  # noqa: E501
            rule_id (str): The unique ID of the rule triggered.. [optional]  # noqa: E501
            created_at (datetime): The date and time when this action was created.. [optional]  # noqa: E501
            outcome (Undefined): [optional]  # noqa: E501
        """
