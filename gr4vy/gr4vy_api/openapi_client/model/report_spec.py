...
class ReportSpec(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, params, *args, **kwargs):  # noqa: E501
        """ReportSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            model (str): The model (dataset) that the data used for the report is retrieved from.. defaults to "transactions", must be one of ["transactions", ]  # noqa: E501
        ...
        model = kwargs.get('model', "transactions")
