...
class FlowRuleServiceOutcome(ModelNormal):
    ...
    def _from_openapi_data(cls, result, *args, **kwargs):  # noqa: E501
        """FlowRuleServiceOutcome - a model defined in OpenAPI

        Args:
            result ([str]): Results for a given flow action.

        Keyword Args:
            type (str): The type of action outcome for the given rule.. defaults to "list", must be one of ["list", ]  # noqa: E501
