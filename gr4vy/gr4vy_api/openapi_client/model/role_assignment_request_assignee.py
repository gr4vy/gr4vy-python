...
class RoleAssignmentRequestAssignee(ModelNormal):
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        """RoleAssignmentRequestAssignee - a model defined in OpenAPI

        Args:
            id (str): The ID of the assignee to associate with the role assignment.

        Keyword Args:
            type (str): The type of the assignee to associate with the role assignment.. defaults to "user", must be one of ["user", ]  # noqa: E501
