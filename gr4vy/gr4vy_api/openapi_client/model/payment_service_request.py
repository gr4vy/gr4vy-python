...
class PaymentServiceRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, payment_service_definition_id, display_name, fields, accepted_countries, accepted_currencies, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            fields ([PaymentServiceRequestFields]): A list of fields, each containing a key-value pair for each field defined by the definition for this payment service e.g. for stripe-card `secret_key` is required and so must be sent within this field.
        ...
        self.payment_service_definition_id = payment_service_definition_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, payment_service_definition_id, display_name, fields, accepted_countries, accepted_currencies, *args, **kwargs):  # noqa: E501
        """PaymentServiceRequest - a model defined in OpenAPI
