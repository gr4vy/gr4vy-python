...
class UserUpdate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The full name of the user which is used in the Gr4vy admin panel to give a user a human readable name.. [optional]  # noqa: E501
            role_ids ([str]): The IDs of the roles to assign to the user. Sending an empty list will remove all roles assigned to the user.. [optional]  # noqa: E501
        """
