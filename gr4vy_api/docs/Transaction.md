...
**payment_method** | **bool, date, datetime, dict, float, int, list, str, none_type** | The payment method used for this transaction. | [optional] 
**buyer** | **bool, date, datetime, dict, float, int, list, str, none_type** | The buyer used for this transaction. | [optional] 
