...
class CardRuleRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, conditions, payment_service_ids, *args, **kwargs):  # noqa: E501
        """CardRuleRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            position (float): The numeric rank of a rule. Rules with a lower position value are processed first. When a rule is inserted at a position, any rules with the the same value or higher are down a position accordingly. When left out, the rule is inserted at the end of the list.. [optional]  # noqa: E501
        ...
        self.payment_service_ids = payment_service_ids
    ...
    @convert_js_args_to_python_args
    def __init__(self, conditions, payment_service_ids, *args, **kwargs):  # noqa: E501
        """CardRuleRequest - a model defined in OpenAPI
