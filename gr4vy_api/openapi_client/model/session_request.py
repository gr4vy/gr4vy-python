...
class SessionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email_address, password, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, email_address, password, *args, **kwargs):  # noqa: E501
        """SessionRequest - a model defined in OpenAPI
