...
class CardRuleCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, match, key, operator, value, *args, **kwargs):  # noqa: E501
        """CardRuleCondition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, match, key, operator, value, *args, **kwargs):  # noqa: E501
        """CardRuleCondition - a model defined in OpenAPI
