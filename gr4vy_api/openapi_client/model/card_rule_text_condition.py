...
class CardRuleTextCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, operator, value, *args, **kwargs):  # noqa: E501
        """CardRuleTextCondition - a model defined in OpenAPI
        ...
        Keyword Args:
            match (str): `text`.. defaults to "text", must be one of ["text", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, operator, value, *args, **kwargs):  # noqa: E501
        """CardRuleTextCondition - a model defined in OpenAPI
