...
class Payouts(BaseSDK):
    def list(
        ...
        *,
        ...
        status: OptionalNullable[Iterable[models.PayoutStatus]] = UNSET,
        ...
        :param created_at_lte: Filters the results to only payouts created before this ISO date-time string. The time zone must be included. Ensure that the date-time string is URL encoded, e.g. `2022-01-01T12:00:00+08:00` must be encoded as `2022-01-01T12%3A00%3A00%2B08%3A00`.
        :param created_at_gte: Filters the results to only payouts created after this ISO date-time string. The time zone must be included. Ensure that the date-time string is URL encoded, e.g. `2022-01-01T12:00:00+08:00` must be encoded as `2022-01-01T12%3A00%3A00%2B08%3A00`.
        :param updated_at_lte: Filters the results to only payouts updated before this ISO date-time string. The time zone must be included. Ensure that the date-time string is URL encoded, e.g. `2022-01-01T12:00:00+08:00` must be encoded as `2022-01-01T12%3A00%3A00%2B08%3A00`.
        :param updated_at_gte: Filters the results to only payouts updated after this ISO date-time string. The time zone must be included. Ensure that the date-time string is URL encoded, e.g. `2022-01-01T12:00:00+08:00` must be encoded as `2022-01-01T12%3A00%3A00%2B08%3A00`.
        :param external_identifier: Filters the results to only the payouts that have an `external_identifier` that exactly matches this value.
        :param payment_service_payout_id: Filters the results to only the payouts that have a `payment_service_payout_id` that exactly matches this value.
        :param status: Filters the results to only the payouts that have a `status` that matches with any of the provided status values.
        ...
        request = models.ListPayoutsRequest(
            ...
            payment_service_payout_id=payment_service_payout_id,
            status=utils.unmarshal(status, OptionalNullable[List[models.PayoutStatus]]),
