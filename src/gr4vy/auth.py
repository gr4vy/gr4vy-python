...
class JWTScope(str, enum.Enum):
    ...
    API_KEY_PAIRS_READ = "api-key-pairs.read"
    API_KEY_PAIRS_WRITE = "api-key-pairs.write"
    ...
    BIN_CHECKER_READ = "bin-checker.read"
    BIN_CHECKER_WRITE = "bin-checker.write"
    ...
    THREE_DS_SCENARIOS_READ = "three-ds-scenarios.read"
    THREE_DS_SCENARIOS_WRITE = "three-ds-scenarios.write"
