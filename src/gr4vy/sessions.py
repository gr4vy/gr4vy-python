...
class Sessions(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.Response403CreateGooglePayDigitalWalletSessionUnion,
            )
            raise errors.Response403CreateGooglePayDigitalWalletSession(
                data=response_data
            )
    ...
    def apple_pay(
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.Response403CreateApplePayDigitalWalletSessionUnion
            )
            raise errors.Response403CreateApplePayDigitalWalletSession(
                data=response_data
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error404Data)
    ...
    def click_to_pay(
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.Response403CreateClickToPayDigitalWalletSessionUnion,
            )
            raise errors.Response403CreateClickToPayDigitalWalletSession(
                data=response_data
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error404Data)
