...
class DeleteThreeDsScenarioGlobalsTypedDict(TypedDict):
    merchant_account_id: NotRequired[str]
    r"""The ID of the merchant account to use for this request."""


class DeleteThreeDsScenarioGlobals(BaseModel):
...
class DeleteThreeDsScenarioRequestTypedDict(TypedDict):
...
class DeleteThreeDsScenarioRequest(BaseModel):
