...
class BACSBankPaymentMethodCreateTypedDict(TypedDict):
    r"""BACS Bank Payment Method
    ...
    account_number: str
    r"""The account number for this BACS bank account"""
    routing_number: str
    r"""The sort code for this BACS bank account"""
    method: Literal["bank"]
    r"""Always `bank`."""
...
class BACSBankPaymentMethodCreate(BaseModel):
    r"""BACS Bank Payment Method
    ...
    SCHEME: Annotated[
        Annotated[Optional[Literal["bacs"]], AfterValidator(validate_const("bacs"))],
...
try:
    BACSBankPaymentMethodCreate.model_rebuild()
except NameError:
    pass
