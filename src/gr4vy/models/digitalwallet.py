...
from .digitalwalletaddress import DigitalWalletAddress, DigitalWalletAddressTypedDict
...
class DigitalWalletTypedDict(TypedDict):
    ...
    address: NotRequired[Nullable[DigitalWalletAddressTypedDict]]
    r"""The merchant address associated with the digital wallet."""
    extra_configuration: NotRequired[Nullable[Dict[str, Any]]]
    r"""Provider-specific configuration. Currently only used by Paze."""
...
class DigitalWallet(BaseModel):
    ...
    address: OptionalNullable[DigitalWalletAddress] = UNSET
    r"""The merchant address associated with the digital wallet."""
