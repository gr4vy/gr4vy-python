...
class IncrementTransactionAuthorizationGlobalsTypedDict(TypedDict):
    merchant_account_id: NotRequired[str]
    r"""The ID of the merchant account to use for this request."""


class IncrementTransactionAuthorizationGlobals(BaseModel):
...
class IncrementTransactionAuthorizationRequestTypedDict(TypedDict):
    transaction_id: str
    r"""The unique identifier of the transaction."""
    transaction_authorization_increment_create: (
        TransactionAuthorizationIncrementCreateTypedDict
    )
    merchant_account_id: NotRequired[str]
    r"""The ID of the merchant account to use for this request."""
...
class IncrementTransactionAuthorizationRequest(BaseModel):
    transaction_id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""The unique identifier of the transaction."""

    transaction_authorization_increment_create: Annotated[
        TransactionAuthorizationIncrementCreate,
