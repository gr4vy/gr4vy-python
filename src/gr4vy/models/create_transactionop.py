...
CreateTransactionResponseTypedDict = TypeAliasType(
    "CreateTransactionResponseTypedDict", Union[TransactionTypedDict, Any]
)


CreateTransactionResponse = TypeAliasType(
    "CreateTransactionResponse", Union[Transaction, Any]
)
