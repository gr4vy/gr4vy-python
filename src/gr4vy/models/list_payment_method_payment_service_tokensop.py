...
class ListPaymentMethodPaymentServiceTokensRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["payment_service_id", "merchantAccountId"]
        nullable_fields = ["payment_service_id", "merchantAccountId"]
        null_default_fields = []
