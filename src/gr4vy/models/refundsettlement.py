...
class RefundSettlementTypedDict(TypedDict):
    r"""A settlement record for a refund on a transaction."""
    ...
    refund_id: str
    r"""The refund this settlement is associated with."""
    ...
    type: Literal["refund-settlement"]
    r"""Always `refund-settlement`."""
...
class RefundSettlement(BaseModel):
    ...
    TYPE: Annotated[
        Annotated[
            Optional[Literal["refund-settlement"]],
            AfterValidator(validate_const("refund-settlement")),
        ],
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["exchange_rate", "interchange", "markup", "scheme_fee", "type"]
        )
        nullable_fields = set(["exchange_rate", "interchange", "markup", "scheme_fee"])
...
try:
    RefundSettlement.model_rebuild()
except NameError:
    pass
