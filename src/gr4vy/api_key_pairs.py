...
class APIKeyPairs(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListAPIKeyPairsResponse]:
        r"""List all API key pairs
        ...
        request = models.ListAPIKeyPairsRequest(
            cursor=cursor,
            limit=limit,
        )
        ...
        def next_func() -> Optional[models.ListAPIKeyPairsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAPIKeyPairsResponse(
                result=unmarshal_json_response(models.CollectionAPIKeyPair, http_res),
                next=next_func,
            )
    ...
    def create(
        ...
        *,
        ...
        algorithm: Optional[models.CertificateAlgorithm] = None,
        active: Optional[bool] = True,
        merchant_account_ids: Optional[Iterable[str]] = None,
        ...
        :param public_key: A PEM-encoded ECDSA P-521 (ES512) public key. Provide this to register your own key pair (bring your own key); If omitted, Gr4vy will generate the key pair and return the private key.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.APIKeyPairCreate(
            display_name=display_name,
            algorithm=algorithm,
            active=active,
            role_ids=utils.unmarshal(role_ids, List[str]),
            merchant_account_ids=utils.unmarshal(
                merchant_account_ids, Optional[List[str]]
            ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.APIKeyPairCreate
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.APIKeyPair, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.Error400Data, http_res)
            raise errors.Error400(response_data, http_res)
        if utils.match_response(http_res, "401", "application/json"):
    ...
    def get(
        ...
        *,
        ...
        r"""Get an API key pair

        Fetches an API key pair by its ID.

        :param api_key_pair_id: The ID of the API key pair.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetAPIKeyPairRequest(
            api_key_pair_id=api_key_pair_id,
        )

        req = self._build_request(
            method="GET",
            path="/api-key-pairs/{api_key_pair_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def update(
        ...
        *,
        ...
        role_ids: OptionalNullable[Iterable[str]] = UNSET,
        merchant_account_ids: OptionalNullable[Iterable[str]] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.APIKeyPair:
        r"""Update an API key pair

        Updates an API key pair.

        :param api_key_pair_id: The ID of the API key pair.
        :param display_name: The display name for the API key pair.
        :param active: Whether the API key pair is active and can be used to authenticate.
        :param role_ids:
        :param merchant_account_ids: The IDs of the merchant accounts to associate with the API key pair. The caller can only assign merchant accounts it has access to.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.UpdateAPIKeyPairRequest(
            api_key_pair_id=api_key_pair_id,
            api_key_pair_update=models.APIKeyPairUpdate(
                display_name=display_name,
                active=active,
                role_ids=utils.unmarshal(role_ids, OptionalNullable[List[str]]),
                merchant_account_ids=utils.unmarshal(
                    merchant_account_ids, OptionalNullable[List[str]]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.api_key_pair_update,
                False,
                False,
                "json",
                models.APIKeyPairUpdate,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="update_api_key_pair",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def delete(
        ...
        *,
        ...
        request = models.DeleteAPIKeyPairRequest(
            api_key_pair_id=api_key_pair_id,
        )
