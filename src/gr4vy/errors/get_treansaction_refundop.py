...
Response403GetTreansactionRefundUnion = TypeAliasType(
...
class Response403GetTreansactionRefund(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetTreansactionRefundUnion

    def __init__(self, data: Response403GetTreansactionRefundUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetTreansactionRefundUnion)
