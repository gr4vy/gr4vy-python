...
class TransactionsRefundSettlements(BaseSDK):
    def get(
        self,
        *,
        transaction_id: str,
    ...
    ) -> models.RefundSettlement:
        r"""Get transaction refund settlement
        ...
        :param settlement_id: The unique identifier of the refund settlement.
        ...
        request = models.GetTransactionRefundSettlementRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/transactions/{transaction_id}/refund-settlements/{settlement_id}",
            base_url=base_url,
            ...
            _globals=models.GetTransactionRefundSettlementGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="get_transaction_refund_settlement",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Transactions - Refund settlements"],
                extensions=None,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.RefundSettlement, http_res)
    ...
    def list(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.RefundSettlements:
        r"""List transaction refund settlements
        ...
        request = models.ListTransactionRefundSettlementsRequest(
            transaction_id=transaction_id,
            merchant_account_id=merchant_account_id,
        )
        ...
        req = self._build_request(
            method="GET",
            path="/transactions/{transaction_id}/refund-settlements",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.ListTransactionRefundSettlementsGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="list_transaction_refund_settlements",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.RefundSettlements, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.Error400Data, http_res)
            raise errors.Error400(response_data, http_res)
        if utils.match_response(http_res, "401", "application/json"):
