...
from gr4vy.three_ds_configuration import ThreeDsConfiguration
...
class MerchantAccountsSDK(BaseSDK):
    three_ds_configuration: ThreeDsConfiguration
    ...
    def _init_sdks(self):
        self.three_ds_configuration = ThreeDsConfiguration(
