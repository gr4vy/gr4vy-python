...
class ThreeDsConfiguration(BaseSDK):
    def create(
        self,
        *,
    ...
    ) -> models.MerchantAccountThreeDSConfiguration:
        r"""Create 3DS configuration for merchant

        Create a new 3DS configuration for a merchant account.

        :param merchant_account_id: The ID of the merchant account.
        :param merchant_acquirer_bin: Acquirer BIN to use when calling 3DS through this scheme.
        :param merchant_acquirer_id: Merchant ID to use when calling 3DS through this scheme.
        :param merchant_name:
        :param merchant_country_code: The merchant's ISO 3166-1 numeric country code.
        :param merchant_category_code: Merchant category code to use when calling 3DS through this scheme.
        :param merchant_url: URL to send when calling 3DS through this scheme.
        :param scheme:
        :param metadata: Any additional information about the 3DS configuration that you would like to store as key-value pairs.
        :param currency: ISO 4217 currency code (3 characters). If left null, the configuration will apply to all currencies.
        ...
        request = models.CreateThreeDsConfigurationRequest(
            merchant_account_id=merchant_account_id,
            merchant_account_three_ds_configuration_create=models.MerchantAccountThreeDSConfigurationCreate(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.merchant_account_three_ds_configuration_create,
                False,
                False,
                "json",
                models.MerchantAccountThreeDSConfigurationCreate,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="create_three_ds_configuration",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Merchant accounts - 3DS configuration"],
                extensions=None,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.MerchantAccountThreeDSConfiguration, http_res
            )
    ...
    def list(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.MerchantAccountThreeDSConfigurations:
        r"""List 3DS configurations for merchant
        ...
        request = models.ListThreeDsConfigurationsRequest(
            merchant_account_id=merchant_account_id,
            currency=currency,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="list_three_ds_configurations",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MerchantAccountThreeDSConfigurations, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.Error400Data, http_res)
            raise errors.Error400(response_data, http_res)
    ...
    def update(
        ...
        *,
        ...
        r"""Edit 3DS configuration

        Update the 3DS configuration for a merchant account.

        :param merchant_account_id: The ID of the merchant account.
        :param three_ds_configuration_id: The ID of the 3DS configuration for a merchant account.
        :param merchant_acquirer_bin: Acquirer BIN to use when calling 3DS through this scheme.
        :param merchant_acquirer_id: Merchant ID to use when calling 3DS through this scheme.
        :param merchant_name:
        :param merchant_country_code: The merchant's ISO 3166-1 numeric country code.
        :param merchant_category_code: Merchant category code to use when calling 3DS through this scheme.
        :param merchant_url: URL to send when calling 3DS through this scheme.
        :param scheme: The card scheme for this 3DS configuration
        :param currency: ISO 4217 currency code (3 characters). If left null, the configuration will apply to all currencies.
        :param metadata: Any additional information about the 3DS configuration that you would like to store as key-value pairs.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        request = models.EditThreeDsConfigurationRequest(
            merchant_account_id=merchant_account_id,
            three_ds_configuration_id=three_ds_configuration_id,
            merchant_account_three_ds_configuration_update=models.MerchantAccountThreeDSConfigurationUpdate(
                merchant_acquirer_bin=merchant_acquirer_bin,
                merchant_acquirer_id=merchant_acquirer_id,
                merchant_name=merchant_name,
                merchant_country_code=merchant_country_code,
        ...
        req = self._build_request(
            method="PUT",
            path="/merchant-accounts/{merchant_account_id}/three-ds-configurations/{three_ds_configuration_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.merchant_account_three_ds_configuration_update,
                False,
                False,
                "json",
                models.MerchantAccountThreeDSConfigurationUpdate,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="edit_three_ds_configuration",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def delete(
        ...
        *,
        ...
        r"""Delete 3DS configuration for a merchant
        ...
        request = models.DeleteThreeDsConfigurationRequest(
            merchant_account_id=merchant_account_id,
            three_ds_configuration_id=three_ds_configuration_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="delete_three_ds_configuration",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
