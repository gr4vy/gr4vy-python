...
class BuyersPaymentMethods(BaseSDK):
    def list(
        ...
        *,
        ...
        sort_by: OptionalNullable[models.ListBuyerPaymentMethodsSortBy] = UNSET,
        order_by: Optional[models.ListBuyerPaymentMethodsOrderBy] = "desc",
