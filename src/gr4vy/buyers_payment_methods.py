...
class BuyersPaymentMethods(BaseSDK):
    def list(
        ...
        *,
        ...
        order_by: Optional[models.OrderBy] = models.OrderBy.DESC,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.Response403ListBuyerPaymentMethodsUnion
            )
            raise errors.Response403ListBuyerPaymentMethods(data=response_data)
