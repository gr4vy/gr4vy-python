...
class Issuances(BaseSDK):
    def create(
        ...
        *,
    ...
    ) -> models.GiftCardIssuance:
        r"""Issue a gift card

        Issue a new virtual gift card through the primary gift card service.

        :param theme: The provider theme code to issue the gift card against.
        :param amount: The amount to load onto the gift card, in the smallest denomination for the currency.
        :param currency: The ISO-4217 currency code for the `amount`.
        :param idempotency_key: A unique key forwarded to the gift card service to make the issuance idempotent.
        :param merchant_account_id: The ID of the merchant account to use for this request.
        :param external_identifier: An optional external identifier for this issuance.
        ...
        request = models.IssueGiftCardRequest(
            idempotency_key=idempotency_key,
            merchant_account_id=merchant_account_id,
            gift_card_issuance_create=models.GiftCardIssuanceCreate(
                theme=theme,
                amount=amount,
                currency=currency,
        ...
        req = self._build_request(
            ...
            _globals=models.IssueGiftCardGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.gift_card_issuance_create,
                False,
                False,
                "json",
                models.GiftCardIssuanceCreate,
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.GiftCardIssuance, http_res)
