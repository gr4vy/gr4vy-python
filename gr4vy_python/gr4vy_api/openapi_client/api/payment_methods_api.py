...
from gr4vy_python.gr4vy_api.openapi_client.model.payment_methods import PaymentMethods
from gr4vy_python.gr4vy_api.openapi_client.model.payment_methods_tokenized import PaymentMethodsTokenized
    ...
    def __init__(self, api_client=None):
        ...
        def __approve_payment_method(
            ...
            **kwargs
            ...
            >>> thread = api.approve_payment_method(payment_method_id, payment_service_id, async_req=True)
            >>> result = thread.get()
        ...
        self.approve_payment_method = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/payment-methods/{payment_method_id}/approve/{payment_service_id}',
            ...
            callable=__approve_payment_method
        )
        ...
        def __redirect_payment_method_approval(
            self,
        ...
        self.redirect_payment_method_approval = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
            ...
            api_client=api_client,
            callable=__redirect_payment_method_approval
        )
