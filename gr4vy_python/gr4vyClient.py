...
from gr4vy_python.sdk_PaymentMethodTokens import gr4vyPaymentMethodTokens
from gr4vy_python.sdk_PaymentOptions import gr4vyPaymentOptions
from gr4vy_python.sdk_PaymentServiceDefinitions import gr4vyPaymentServiceDefinitions
from gr4vy_python.sdk_PaymentServices import gr4vyPaymentServices
from gr4vy_python.sdk_Transactions import gr4vyTransactions
...
class Gr4vyClient:
    ...
    def UpdatePaymentService(self, payment_service_id, payment_service_update):
        with self.client as api_client:
            api_instance = gr4vyPaymentServices(api_client)
            return api_instance.updatePaymentService(payment_service_id, payment_service_update=payment_service_update)

    def AuthorizeNewTransaction(self, transaction_request):
        with self.client as api_client:
            api_instance = gr4vyTransactions(api_client)
            return api_instance.authorizeNewTransaction(transaction_request = transaction_request)

    def CaptureTransaction(self, transaction_id, transaction_capture_request):
        with self.client as api_client:
            api_instance = gr4vyTransactions(api_client)
            return api_instance.captureTransaction(transaction_id, transaction_capture_request)
