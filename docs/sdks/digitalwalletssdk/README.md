...
| `merchant_category_code`                                                              | *OptionalNullable[str]*                                                               | :heavy_minus_sign:                                                                    | N/A                                                                                   |                                                                                       |
| `address`                                                                             | [OptionalNullable[models.DigitalWalletAddress]](../../models/digitalwalletaddress.md) | :heavy_minus_sign:                                                                    | N/A                                                                                   |                                                                                       |
| `extra_configuration`                                                                 | Dict[str, *Any*]                                                                      | :heavy_minus_sign:                                                                    | N/A                                                                                   |                                                                                       |
...
**[models.DigitalWallets](../../models/digitalwallets.md)**
