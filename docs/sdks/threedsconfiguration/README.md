...
| `currency`                                                                                              | *OptionalNullable[str]*                                                                                 | :heavy_minus_sign:                                                                                      | ISO 4217 currency code (3 characters). If left null, the configuration will apply to all currencies.    | **Example 1:** USD<br/>**Example 2:** EUR<br/>**Example 3:** GBP                                        |
