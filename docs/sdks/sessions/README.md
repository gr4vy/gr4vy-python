...
* [paze_mobile_session_complete](#paze_mobile_session_complete) - Complete a Paze session
...
| `transaction_type`                                                                                                                          | [OptionalNullable[models.PazeMobileSessionCreateRequestTransactionType]](../../models/pazemobilesessioncreaterequesttransactiontype.md)     | :heavy_minus_sign:                                                                                                                          | Type of transaction.                                                                                                                        |                                                                                                                                             |
...
| `billing_preference`                                                                                                                        | [OptionalNullable[models.PazeMobileSessionCreateRequestBillingPreference]](../../models/pazemobilesessioncreaterequestbillingpreference.md) | :heavy_minus_sign:                                                                                                                          | Verbosity of billing address required.                                                                                                      |                                                                                                                                             |
...
## paze_mobile_session_complete

Complete a Paze checkout session and retrieve the secure payload required to settle the payment.

### Example Usage

<!-- UsageSnippet language="python" operationID="complete_paze_mobile_session" method="post" path="/digital-wallets/paze/session/complete" -->
```python
from gr4vy import Gr4vy
import os
...
**[models.PazeSessionComplete](../../models/pazesessioncomplete.md)**
