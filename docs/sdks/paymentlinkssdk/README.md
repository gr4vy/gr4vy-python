...
| `country`                                                                                                                                                                                                                 | *str*                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                        | The country code for the payment link.                                                                                                                                                                                    | **Example 1:** DE<br/>**Example 2:** GB<br/>**Example 3:** US                                                                                                                                                             |
| `currency`                                                                                                                                                                                                                | *str*                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                        | The currency code for the payment link.                                                                                                                                                                                   | **Example 1:** EUR<br/>**Example 2:** GBP<br/>**Example 3:** USD                                                                                                                                                          |
...
| `locale`                                                                                                                                                                                                                  | *OptionalNullable[str]*                                                                                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                                        | The locale for the payment link.                                                                                                                                                                                          | **Example 1:** en<br/>**Example 2:** en-GB<br/>**Example 3:** pt<br/>**Example 4:** pt-BR<br/>**Example 5:** es                                                                                                           |
