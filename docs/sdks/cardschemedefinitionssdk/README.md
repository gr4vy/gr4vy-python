...
<!-- UsageSnippet language="python" operationID="list_card_scheme_definitions" method="get" path="/card-scheme-definitions" -->
```python
...
**[models.CardSchemeDefinitions](../../models/cardschemedefinitions.md)**
