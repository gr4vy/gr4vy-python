...
with Gr4vy(
    ...
    res = g_client.card_scheme_definitions.list(merchant_account_id="default")
...
**[models.CollectionNoCursorCardSchemeDefinition](../../models/collectionnocursorcardschemedefinition.md)**
